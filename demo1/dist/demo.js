...
export class CarGame extends Base {
    ...
    initPlayer() {
        const mesh = new THREE.Mesh(new THREE.BoxGeometry(10, 10, 10), new THREE.MeshPhongMaterial({ color: 0xffffff }));
        const mesh1 = new THREE.Mesh(new THREE.BoxGeometry(10, 10, 10), new THREE.MeshPhongMaterial({ color: 0xffffff }));
        const mesh2 = new THREE.Mesh(new THREE.BoxGeometry(10, 10, 10), new THREE.MeshPhongMaterial({ color: 0xffffff }));
        const headerMesh = new THREE.Mesh(new THREE.BoxGeometry(20, 20, 10), new THREE.MeshPhongMaterial({ color: 0xff9900 }));
        const footMesh = new THREE.Mesh(new THREE.BoxGeometry(20, 20, 10), new THREE.MeshPhongMaterial({ color: 0xff9900 }));
    ...
    initMap() {
        ...
        for (let i = 1; i <= num; i++) {
            ...
            new THREE.BoxGeometry(100, 10, 100), material);

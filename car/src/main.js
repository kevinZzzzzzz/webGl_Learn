...
const asphaltDiffuse = textureLoader.load(`/textures/brick_pavement_02_disp_1k.png`, undefined, undefined, e => console.warn('加载 c.jpg 失败:', e));
const asphaltNormal = textureLoader.load(`/textures/brick_pavement_02_diff_1k.jpg`, undefined, undefined, e => console.warn('加载 a.jpg 失败:', e));
